...
### Tab.3.2 Login Audit Table (`login_audit`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Audit ID |
| user_id | bigint unsigned | Foreign Key -> users.id | No | - | User who logged in |
| ip_address | varchar(45) | - | Yes | NULL | Login IP address |
| user_agent | varchar(255) | - | Yes | NULL | Browser/client signature |
| logged_in_at | timestamp | - | No | CURRENT_TIMESTAMP | Login timestamp |

### Tab.3.3 Property Table (`properties`)
...
### Tab.3.4 Property Photo Table (`property_photos`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Photo ID |
| property_id | bigint unsigned | Foreign Key -> properties.id | No | - | Related property |
| path | varchar(255) | - | No | - | Stored file path |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

### Tab.3.5 Property Availability Cycle Table (`property_availability_cycles`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Cycle ID |
| property_id | bigint unsigned | Foreign Key -> properties.id | No | - | Related property |
| available_from_at | timestamp | Indexed (with property_id) | No | - | Start of availability |
| unavailable_at | timestamp | Indexed (with property_id) | Yes | NULL | End of availability |
| closed_by | enum('rented','maintenance','manual') | - | Yes | NULL | Reason for closing |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

Additional indexes:
- `pac_property_available_idx` on (`property_id`, `available_from_at`)
- `pac_property_unavailable_idx` on (`property_id`, `unavailable_at`)

### Tab.3.6 Rental Request Table (`rental_requests`)
...
### Tab.3.7 Transaction Table (`transactions`)
...
### Tab.3.8 Contract Table (`contracts`)
...
### Tab.3.9 Contract Extension Table (`contract_extensions`)
...
### Tab.3.10 Conversation Table (`conversations`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Conversation ID |
| property_id | bigint unsigned | Foreign Key -> properties.id | No | - | Main property context |
| tenant_id | bigint unsigned | Foreign Key -> users.id | No | - | Tenant participant |
| agent_id | bigint unsigned | Foreign Key -> users.id | No | - | Agent participant |
| rental_request_id | bigint unsigned | Foreign Key -> rental_requests.id | Yes | NULL | Optional request context |
| status | enum('open','closed') | - | No | open | Conversation status |
| last_message_at | timestamp | - | Yes | NULL | Last message timestamp |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

Additional constraints:
- unique: (`tenant_id`, `agent_id`) as `conversations_tenant_agent_unique`.

### Tab.3.11 Conversation Message Table (`conversation_messages`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Message ID |
| conversation_id | bigint unsigned | Foreign Key -> conversations.id | No | - | Parent conversation |
| sender_id | bigint unsigned | Foreign Key -> users.id | No | - | Message sender |
| property_id | bigint unsigned | Foreign Key -> properties.id | Yes | NULL | Optional property context |
| rental_request_id | bigint unsigned | Foreign Key -> rental_requests.id | Yes | NULL | Optional request context |
| message | text | - | No | - | Message content |
| created_at | timestamp | Indexed with conversation_id | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

Additional indexes:
- `cm_conversation_created_idx` on (`conversation_id`, `created_at`).

### Tab.3.12 Facility Table (`facilities`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Facility ID |
| slug | varchar(50) | Unique | No | - | Facility code |
| name | varchar(100) | - | No | - | Facility name |
| category | enum('utilities','interior','outdoor') | Indexed | No | - | Facility category |
| is_active | tinyint(1) | - | No | 1 | Active flag |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

### Tab.3.13 Property Facility Pivot Table (`property_facility`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Pivot record ID |
| property_id | bigint unsigned | Foreign Key -> properties.id | No | - | Property reference |
| facility_id | bigint unsigned | Foreign Key -> facilities.id | No | - | Facility reference |
| value | varchar(100) | - | Yes | NULL | Optional facility value |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |
...
### Tab.3.14 Province Table (`provinces`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Province ID |
| name | varchar(255) | - | No | - | Province name |
| code | varchar(20) | Unique | No | - | Province code |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

### Tab.3.15 Regency Table (`regencies`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Regency ID |
| province_id | bigint unsigned | Foreign Key -> provinces.id, Indexed | No | - | Parent province |
| name | varchar(255) | - | No | - | Regency name |
| code | varchar(20) | Unique | No | - | Regency code |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

### Tab.3.16 District Table (`districts`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | District ID |
| regency_id | bigint unsigned | Foreign Key -> regencies.id, Indexed | No | - | Parent regency |
| name | varchar(255) | - | No | - | District name |
| code | varchar(20) | Unique | No | - | District code |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |

### Tab.3.17 Village Table (`villages`)

| Field | Type | Attributes | Null | Default | Description |
|---|---|---|---|---|---|
| id | bigint unsigned | Primary Key, Auto Increment | No | - | Village ID |
| district_id | bigint unsigned | Foreign Key -> districts.id, Indexed | No | - | Parent district |
| name | varchar(255) | - | No | - | Village name |
| code | varchar(20) | Unique | No | - | Village code |
| created_at | timestamp | - | Yes | NULL | Created time |
| updated_at | timestamp | - | Yes | NULL | Last updated time |
