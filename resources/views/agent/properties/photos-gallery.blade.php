...
<style>
    .agent-breadcrumb .breadcrumb {
        margin-bottom: 0;
    }
    .agent-breadcrumb .breadcrumb-item,
    .agent-breadcrumb .breadcrumb-item a {
        color: #64748b;
        font-size: .9rem;
        text-decoration: none;
    }
    .agent-breadcrumb .breadcrumb-item.active {
        color: #334155;
    }
...
<div class="container">
    <div class="photo-gallery-wrapper">
        <nav class="agent-breadcrumb mb-3" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/agent/properties">My Properties</a></li>
                <li class="breadcrumb-item"><a href="/agent/properties/{{ $property->id }}">Property Detail</a></li>
