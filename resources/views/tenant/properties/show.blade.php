...
@php
    ...
    $photoGalleryBaseUrl = route('houses.photos', ['property' => $property->id]);
...
<div class="container property-detail-page tenant-detail-page">
    ...
    @include('partials.property-gallery-hero', [
        ...
        'galleryUrl' => route('houses.photos', ['property' => $property->id]),
    ...
    <div class="listing-summary">
        ...
        @include('partials.property-sidebar-tenant', [
            'property' => $property,
        ])
    </div>
